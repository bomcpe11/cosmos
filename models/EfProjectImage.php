...
class EfProjectImage extends ActiveRecord
{
    ...
    {
        return [
            [['PROJECT_IMAGE_ID', 'PROJECT_ID', 'IMAGE_PATH', 'THUMBNAIL_IMAGE_PATH', 'CREATE_BY', 'CREATE_DATE', 'LAST_UPD_BY', 'LAST_UPD_DATE'], 'required'],
            [['PROJECT_IMAGE_ID', 'PROJECT_ID', 'CREATE_BY', 'LAST_UPD_BY'], 'integer'],
            [['CREATE_DATE', 'LAST_UPD_DATE'], 'safe'],
            [['IMAGE_PATH', 'THUMBNAIL_IMAGE_PATH', 'IMAGE_DESC'], 'string', 'max' => 255]
        ];
    }
